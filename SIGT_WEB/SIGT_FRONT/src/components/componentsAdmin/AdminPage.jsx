                                    ...
                                    <tr key={emp.ID}>
                                      ...
                                      <td>
                                        <div className="progress mx-auto" style={{ width: "100px", height: "20px" }}>
                                          <div
                                            className={`progress-bar ${progreso >= 75 ? "bg-success" : progreso >= 50 ? "bg-info" : progreso >= 25 ? "bg-warning" : "bg-danger"}`}
                                            role="progressbar"
                                  ...
                                  <div className="d-flex justify-content-between align-items-center p-2 rounded" style={{ backgroundColor: "#e2e7e7ff" }}>
                                    <span className="d-flex align-items-center">
                                      <i
                                        ...
                                        style={{
                                          color: item.EstadoTarea === "Completada" ? "#54e075ff"
                                            : item.EstadoTarea === "En Progreso" ? "#ffd965ff"
                                            : item.EstadoTarea === "Pendiente" ? "#ee5666ff"
                                            : "#6c757d",
                                          fontSize: "10px",
                                        }}
                                      ></i>
