                ...
                {productosPagina.length > 0 ? (
                  productosPagina.map((p, index) => (
                    <tr key={p.idProducto}>
                      ...
                      <td>
                        {p.Stock > 10
                          ? <span className="lp-stock-alto">{p.Stock}</span>
                          : p.Stock > 5
                          ? <span className="lp-stock-medio">{p.Stock}</span>
                          : <span className="lp-stock-bajo">{p.Stock}</span>
                        }
                      </td>
            ...
            <>
              ...
              <div className="lp-pagination">
                ...
                {Array.from({ length: totalPaginas }, (_, i) => i + 1)
                  ...
                  .map((item, i) =>
                    item === "..." ? (
                      <span key={`dots-${i}`} style={{ color:"#b895d4", padding:"0 4px", lineHeight:"36px" }}>…</span>
                    ) : (
                      <button
                        key={item}
