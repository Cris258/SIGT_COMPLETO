  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.id) {
          localStorage.setItem("idPersona", data.id);
        }
        if (data.nombre) {
          localStorage.setItem("Primer_Nombre", data.nombre);
        }
        if (data.apellido) {
          localStorage.setItem("Primer_Apellido", data.apellido);
        }
        ...
        Swal.fire({
          ...
          switch (data.rol) {
            ...
            case "Empleado":
              ...
              break;
            case "Cliente":
              window.location.href = "/TiendaLine";
              break;
            default:
